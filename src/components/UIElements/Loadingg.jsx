...
const Loadingg = () => {
  return (
    <div className="flex min-h-screen max-h-screen gap-4 p-8 bg-[#c6cddb]">
      <div className="flex-1 flex flex-col gap-4">
        <div className="flex flex-1 rounded-lg red-creative shadow-gray-700 shadow-md">
        ...
        <div className="flex-[2] rounded-lg merri shadow-gray-700 shadow-md p-4 bg-gray-300">
          <div
